...
export default function UserProfil() {
    ...
    async function handleSubmitName(e){
        ...
        if(response.status === 200){
            await alertSuccess("Berhasil update")
        }else {
    ...
    useEffectOnce(()=>{
        fetchUserDetail()
            .then(()=> console.log("User detail fetched success"))
    })
    return <>
        <div>
                        ...
                        <form onSubmit={handleSubmitPassword} >
                            ...
                            <div className="mb-5">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="password" id="confirm_password" name="confirm_password" className="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200" placeholder="Confirm your new password" required value={confrimPassword} onChange={(e)=>setConfirmPassword(e.target.value)} />
                                </div>
                            </div>
                            <div className="mt-6">
                                <button type="submit" className="w-full bg-gradient text-white py-3 px-4 rounded-lg hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-all duration-200 font-medium shadow-lg transform hover:-translate-y-0.5 flex items-center justify-center">
